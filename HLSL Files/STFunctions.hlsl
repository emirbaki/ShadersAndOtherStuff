...
void ColorBlend_float(float4 tcol, float4 dcol, float blendf, out float4 Out)
{
    Out = tcol;
    Out.r = lerp(tcol.r, dcol.r, blendf);
    Out.g = lerp(tcol.g, dcol.g, blendf);
    Out.b = lerp(tcol.b, dcol.b, blendf);
    Out.a = lerp(tcol.a, dcol.a, blendf);
}
